...
const data = {
  ...
  description: 'Estamos aquí para ayudarte a hacer realidad tu próximo proyecto',
  services: [
    {
      icon: <Code2 className="size-8 text-primary" />,
      title: 'Desarrollo de Páginas Web',
      description: 'Sitios web únicos y a medida que reflejan la identidad de tu marca.',
    },
    {
